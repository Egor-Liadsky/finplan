...
- **2. Структура репозитория** — строки 182–437
  - 2.1 Дерево каталогов 203–382; 2.2 Правила слоёв 383–437
- **3. Доменная модель** — строки 438–862
  - 3.1 Представление денег 440–488; 3.2 Перечисления 489–511; 3.3 Сущности 512–821; 3.4 Связи сущностей 822–862
- **4. Схема базы данных** — строки 863–1523
  - 4.1 Общие соглашения 865–885; 4.2 Неизменяемый журнал против пересчитываемых данных 886–910; 4.3 Таблицы 911–1271; 4.4 ER-диаграмма 1272–1433; 4.5 Изоляция данных на уровне БД 1434–1523
- **5. Расчётный слой финансов** — строки 1524–1808
  - 5.1 Соглашения о подсчёте дней 1531–1554; 5.2 Сложный процент 1555–1580; 5.3 Эффективная годовая ставка 1581–1602; 5.4 Начисление с пополнениями и снятиями внутри периода 1603–1662; 5.5 XIRR 1663–1719; 5.6 Цели накопления 1720–1755; 5.7 Прочие расчёты 1756–1792; 5.8 Где что считается 1793–1808
- **6. Сценарии Telegram-бота** — строки 1809–2246
  - 6.1 Команды 1816–1837; 6.2 Разбиение на роутеры aiogram 1838–1912; 6.3 Состояния FSM 1913–2050; 6.4 Хранилище состояний 2051–2069; 6.5 Быстрый ввод одной строкой 2070–2119; 6.6 Валидация ввода 2120–2158; 6.7 Главное меню и клавиатуры 2159–2246
- **7. HTTP-API для SPA** — строки 2247–2627
  - 7.1 Сводка эндпоинтов 2260–2360; 7.2 Пагинация 2361–2388; 7.3 Фильтрация 2389–2408; 7.4 Формат ошибок 2409–2449; 7.5 Примеры ключевых ресурсов 2450–2611; 7.6 Общие заголовки и политики 2612–2627
- **8. Аутентификация и авторизация** — строки 2628–2765
  - 8.1 Модель 2630–2648; 8.2 Проверка подписи Telegram Login Widget 2649–2677; 8.3 Токены 2678–2705; 8.4 Диаграмма входа 2706–2733; 8.5 Авторизация и изоляция данных 2734–2765
- **9. Фоновые задачи и планировщик** — строки 2766–2839
  - 9.1 Выбор планировщика 2768–2797; 9.2 Перечень задач 2798–2818; 9.3 Надёжность выполнения 2819–2839
- **10. Конфигурация и запуск** — строки 2840–3026
  - 10.1 Переменные окружения 2842–2885; 10.2 Файлы настроек 2886–2895; 10.3 docker-compose для локальной разработки 2896–2967; 10.4 Миграции при старте 2968–2994; 10.5 Режим бота: polling против webhook 2995–3011; 10.6 Команды Makefile 3012–3026
- **11. Стратегия тестирования** — строки 3027–3130
  - 11.1 Пирамида 3034–3050; 11.2 Тестирование финансовых расчётов 3051–3077; 11.3 Тестирование хендлеров aiogram 3078–3105; 11.4 Тестирование изоляции пользователей 3106–3116; 11.5 Прочее 3117–3130
- **12. Нефункциональные требования** — строки 3131–3269
  - 12.1 Логирование 3133–3156; 12.2 Обработка ошибок 3157–3186; 12.3 Идемпотентность 3187–3218; 12.4 Резервное копирование 3219–3236; 12.5 Производительность и ограничения 3237–3254; 12.6 Приватность и безопасность 3255–3269
- **13. Этапы внедрения** — строки 3270–3389
- **14. Архитектурные решения и открытые вопросы** — строки 3390–3653
  - 14.1 Принятые решения 3392–3590; 14.2 Открытые вопросы к владельцу продукта 3591–3638; 14.3 Что сознательно не проектировалось 3639–3653

## Дерево каталогов, два уровня

Полное дерево — раздел 2.1, строки 203–382.
...
<!-- docs/architecture.md, раздел 2.2, строки 383–437 -->
...
<!-- docs/architecture.md, раздел 3.1, строки 440–488 -->
...
<!-- docs/architecture.md, раздел 4.1, строки 865–885 -->
...
<!-- docs/architecture.md, раздел 11.1, строки 3034–3050 -->
...
<!-- docs/architecture.md, раздел 11.4, строки 3106–3116 -->
...
<!-- docs/architecture.md, раздел 12.1, строки 3133–3156 -->
