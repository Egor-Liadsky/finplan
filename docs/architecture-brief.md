...
- **3. Доменная модель** — строки 393–785
  - 3.1 Представление денег 395–443; 3.2 Перечисления 444–466; 3.3 Сущности 467–744; 3.4 Связи сущностей 745–785
- **4. Схема базы данных** — строки 786–1370
  - 4.1 Общие соглашения 788–808; 4.2 Неизменяемый журнал против пересчитываемых данных 809–833; 4.3 Таблицы 834–1186; 4.4 ER-диаграмма 1187–1348; 4.5 Изоляция данных на уровне БД 1349–1370
- **5. Расчётный слой финансов** — строки 1371–1655
  - 5.1 Соглашения о подсчёте дней 1378–1401; 5.2 Сложный процент 1402–1427; 5.3 Эффективная годовая ставка 1428–1449; 5.4 Начисление с пополнениями и снятиями внутри периода 1450–1509; 5.5 XIRR 1510–1566; 5.6 Цели накопления 1567–1602; 5.7 Прочие расчёты 1603–1639; 5.8 Где что считается 1640–1655
- **6. Сценарии Telegram-бота** — строки 1656–1945
  - 6.1 Команды 1663–1684; 6.2 Разбиение на роутеры aiogram 1685–1718; 6.3 Состояния FSM 1719–1792; 6.4 Хранилище состояний 1793–1811; 6.5 Быстрый ввод одной строкой 1812–1861; 6.6 Валидация ввода 1862–1881; 6.7 Главное меню и клавиатуры 1882–1945
- **7. HTTP-API для SPA** — строки 1946–2326
  - 7.1 Сводка эндпоинтов 1959–2059; 7.2 Пагинация 2060–2087; 7.3 Фильтрация 2088–2107; 7.4 Формат ошибок 2108–2148; 7.5 Примеры ключевых ресурсов 2149–2310; 7.6 Общие заголовки и политики 2311–2326
- **8. Аутентификация и авторизация** — строки 2327–2464
  - 8.1 Модель 2329–2347; 8.2 Проверка подписи Telegram Login Widget 2348–2376; 8.3 Токены 2377–2404; 8.4 Диаграмма входа 2405–2432; 8.5 Авторизация и изоляция данных 2433–2464
- **9. Фоновые задачи и планировщик** — строки 2465–2538
  - 9.1 Выбор планировщика 2467–2496; 9.2 Перечень задач 2497–2517; 9.3 Надёжность выполнения 2518–2538
- **10. Конфигурация и запуск** — строки 2539–2724
  - 10.1 Переменные окружения 2541–2583; 10.2 Файлы настроек 2584–2593; 10.3 docker-compose для локальной разработки 2594–2665; 10.4 Миграции при старте 2666–2692; 10.5 Режим бота: polling против webhook 2693–2709; 10.6 Команды Makefile 2710–2724
- **11. Стратегия тестирования** — строки 2725–2828
  - 11.1 Пирамида 2732–2748; 11.2 Тестирование финансовых расчётов 2749–2775; 11.3 Тестирование хендлеров aiogram 2776–2803; 11.4 Тестирование изоляции пользователей 2804–2814; 11.5 Прочее 2815–2828
- **12. Нефункциональные требования** — строки 2829–2967
  - 12.1 Логирование 2831–2854; 12.2 Обработка ошибок 2855–2884; 12.3 Идемпотентность 2885–2916; 12.4 Резервное копирование 2917–2934; 12.5 Производительность и ограничения 2935–2952; 12.6 Приватность и безопасность 2953–2967
- **13. Этапы внедрения** — строки 2968–3087
- **14. Архитектурные решения и открытые вопросы** — строки 3088–3351
  - 14.1 Принятые решения 3090–3288; 14.2 Открытые вопросы к владельцу продукта 3289–3336; 14.3 Что сознательно не проектировалось 3337–3351
...
<!-- docs/architecture.md, раздел 4.1, строки 788–808 -->
...
<!-- docs/architecture.md, раздел 11.1, строки 2732–2748 -->
...
<!-- docs/architecture.md, раздел 11.4, строки 2804–2814 -->
...
<!-- docs/architecture.md, раздел 12.1, строки 2831–2854 -->
