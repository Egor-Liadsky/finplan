...
- **6. Сценарии Telegram-бота** — строки 1809–2215
  - 6.1 Команды 1816–1837; 6.2 Разбиение на роутеры aiogram 1838–1912; 6.3 Состояния FSM 1913–2028; 6.4 Хранилище состояний 2029–2047; 6.5 Быстрый ввод одной строкой 2048–2097; 6.6 Валидация ввода 2098–2136; 6.7 Главное меню и клавиатуры 2137–2215
- **7. HTTP-API для SPA** — строки 2216–2596
  - 7.1 Сводка эндпоинтов 2229–2329; 7.2 Пагинация 2330–2357; 7.3 Фильтрация 2358–2377; 7.4 Формат ошибок 2378–2418; 7.5 Примеры ключевых ресурсов 2419–2580; 7.6 Общие заголовки и политики 2581–2596
- **8. Аутентификация и авторизация** — строки 2597–2734
  - 8.1 Модель 2599–2617; 8.2 Проверка подписи Telegram Login Widget 2618–2646; 8.3 Токены 2647–2674; 8.4 Диаграмма входа 2675–2702; 8.5 Авторизация и изоляция данных 2703–2734
- **9. Фоновые задачи и планировщик** — строки 2735–2808
  - 9.1 Выбор планировщика 2737–2766; 9.2 Перечень задач 2767–2787; 9.3 Надёжность выполнения 2788–2808
- **10. Конфигурация и запуск** — строки 2809–2995
  - 10.1 Переменные окружения 2811–2854; 10.2 Файлы настроек 2855–2864; 10.3 docker-compose для локальной разработки 2865–2936; 10.4 Миграции при старте 2937–2963; 10.5 Режим бота: polling против webhook 2964–2980; 10.6 Команды Makefile 2981–2995
- **11. Стратегия тестирования** — строки 2996–3099
  - 11.1 Пирамида 3003–3019; 11.2 Тестирование финансовых расчётов 3020–3046; 11.3 Тестирование хендлеров aiogram 3047–3074; 11.4 Тестирование изоляции пользователей 3075–3085; 11.5 Прочее 3086–3099
- **12. Нефункциональные требования** — строки 3100–3238
  - 12.1 Логирование 3102–3125; 12.2 Обработка ошибок 3126–3155; 12.3 Идемпотентность 3156–3187; 12.4 Резервное копирование 3188–3205; 12.5 Производительность и ограничения 3206–3223; 12.6 Приватность и безопасность 3224–3238
- **13. Этапы внедрения** — строки 3239–3358
- **14. Архитектурные решения и открытые вопросы** — строки 3359–3622
  - 14.1 Принятые решения 3361–3559; 14.2 Открытые вопросы к владельцу продукта 3560–3607; 14.3 Что сознательно не проектировалось 3608–3622
...
<!-- docs/architecture.md, раздел 11.1, строки 3003–3019 -->
...
<!-- docs/architecture.md, раздел 11.4, строки 3075–3085 -->
...
<!-- docs/architecture.md, раздел 12.1, строки 3102–3125 -->
