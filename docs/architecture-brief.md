...
- **3. Доменная модель** — строки 434–833
  - 3.1 Представление денег 436–484; 3.2 Перечисления 485–507; 3.3 Сущности 508–792; 3.4 Связи сущностей 793–833
- **4. Схема базы данных** — строки 834–1418
  - 4.1 Общие соглашения 836–856; 4.2 Неизменяемый журнал против пересчитываемых данных 857–881; 4.3 Таблицы 882–1234; 4.4 ER-диаграмма 1235–1396; 4.5 Изоляция данных на уровне БД 1397–1418
- **5. Расчётный слой финансов** — строки 1419–1703
  - 5.1 Соглашения о подсчёте дней 1426–1449; 5.2 Сложный процент 1450–1475; 5.3 Эффективная годовая ставка 1476–1497; 5.4 Начисление с пополнениями и снятиями внутри периода 1498–1557; 5.5 XIRR 1558–1614; 5.6 Цели накопления 1615–1650; 5.7 Прочие расчёты 1651–1687; 5.8 Где что считается 1688–1703
- **6. Сценарии Telegram-бота** — строки 1704–1995
  - 6.1 Команды 1711–1732; 6.2 Разбиение на роутеры aiogram 1733–1768; 6.3 Состояния FSM 1769–1842; 6.4 Хранилище состояний 1843–1861; 6.5 Быстрый ввод одной строкой 1862–1911; 6.6 Валидация ввода 1912–1931; 6.7 Главное меню и клавиатуры 1932–1995
- **7. HTTP-API для SPA** — строки 1996–2376
  - 7.1 Сводка эндпоинтов 2009–2109; 7.2 Пагинация 2110–2137; 7.3 Фильтрация 2138–2157; 7.4 Формат ошибок 2158–2198; 7.5 Примеры ключевых ресурсов 2199–2360; 7.6 Общие заголовки и политики 2361–2376
- **8. Аутентификация и авторизация** — строки 2377–2514
  - 8.1 Модель 2379–2397; 8.2 Проверка подписи Telegram Login Widget 2398–2426; 8.3 Токены 2427–2454; 8.4 Диаграмма входа 2455–2482; 8.5 Авторизация и изоляция данных 2483–2514
- **9. Фоновые задачи и планировщик** — строки 2515–2588
  - 9.1 Выбор планировщика 2517–2546; 9.2 Перечень задач 2547–2567; 9.3 Надёжность выполнения 2568–2588
- **10. Конфигурация и запуск** — строки 2589–2774
  - 10.1 Переменные окружения 2591–2633; 10.2 Файлы настроек 2634–2643; 10.3 docker-compose для локальной разработки 2644–2715; 10.4 Миграции при старте 2716–2742; 10.5 Режим бота: polling против webhook 2743–2759; 10.6 Команды Makefile 2760–2774
- **11. Стратегия тестирования** — строки 2775–2878
  - 11.1 Пирамида 2782–2798; 11.2 Тестирование финансовых расчётов 2799–2825; 11.3 Тестирование хендлеров aiogram 2826–2853; 11.4 Тестирование изоляции пользователей 2854–2864; 11.5 Прочее 2865–2878
- **12. Нефункциональные требования** — строки 2879–3017
  - 12.1 Логирование 2881–2904; 12.2 Обработка ошибок 2905–2934; 12.3 Идемпотентность 2935–2966; 12.4 Резервное копирование 2967–2984; 12.5 Производительность и ограничения 2985–3002; 12.6 Приватность и безопасность 3003–3017
- **13. Этапы внедрения** — строки 3018–3137
- **14. Архитектурные решения и открытые вопросы** — строки 3138–3401
  - 14.1 Принятые решения 3140–3338; 14.2 Открытые вопросы к владельцу продукта 3339–3386; 14.3 Что сознательно не проектировалось 3387–3401
...
<!-- docs/architecture.md, раздел 4.1, строки 836–856 -->
...
<!-- docs/architecture.md, раздел 11.1, строки 2782–2798 -->
...
<!-- docs/architecture.md, раздел 11.4, строки 2854–2864 -->
...
<!-- docs/architecture.md, раздел 12.1, строки 2881–2904 -->
