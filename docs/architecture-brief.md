...
- **6. Сценарии Telegram-бота** — строки 1810–2247
  - 6.1 Команды 1817–1838; 6.2 Разбиение на роутеры aiogram 1839–1913; 6.3 Состояния FSM 1914–2051; 6.4 Хранилище состояний 2052–2070; 6.5 Быстрый ввод одной строкой 2071–2120; 6.6 Валидация ввода 2121–2159; 6.7 Главное меню и клавиатуры 2160–2247
- **7. HTTP-API для SPA** — строки 2248–2628
  - 7.1 Сводка эндпоинтов 2261–2361; 7.2 Пагинация 2362–2389; 7.3 Фильтрация 2390–2409; 7.4 Формат ошибок 2410–2450; 7.5 Примеры ключевых ресурсов 2451–2612; 7.6 Общие заголовки и политики 2613–2628
- **8. Аутентификация и авторизация** — строки 2629–2766
  - 8.1 Модель 2631–2649; 8.2 Проверка подписи Telegram Login Widget 2650–2678; 8.3 Токены 2679–2706; 8.4 Диаграмма входа 2707–2734; 8.5 Авторизация и изоляция данных 2735–2766
- **9. Фоновые задачи и планировщик** — строки 2767–2840
  - 9.1 Выбор планировщика 2769–2798; 9.2 Перечень задач 2799–2819; 9.3 Надёжность выполнения 2820–2840
- **10. Конфигурация и запуск** — строки 2841–3027
  - 10.1 Переменные окружения 2843–2886; 10.2 Файлы настроек 2887–2896; 10.3 docker-compose для локальной разработки 2897–2968; 10.4 Миграции при старте 2969–2995; 10.5 Режим бота: polling против webhook 2996–3012; 10.6 Команды Makefile 3013–3027
- **11. Стратегия тестирования** — строки 3028–3131
  - 11.1 Пирамида 3035–3051; 11.2 Тестирование финансовых расчётов 3052–3078; 11.3 Тестирование хендлеров aiogram 3079–3106; 11.4 Тестирование изоляции пользователей 3107–3117; 11.5 Прочее 3118–3131
- **12. Нефункциональные требования** — строки 3132–3270
  - 12.1 Логирование 3134–3157; 12.2 Обработка ошибок 3158–3187; 12.3 Идемпотентность 3188–3219; 12.4 Резервное копирование 3220–3237; 12.5 Производительность и ограничения 3238–3255; 12.6 Приватность и безопасность 3256–3270
- **13. Этапы внедрения** — строки 3271–3390
- **14. Архитектурные решения и открытые вопросы** — строки 3391–3654
  - 14.1 Принятые решения 3393–3591; 14.2 Открытые вопросы к владельцу продукта 3592–3639; 14.3 Что сознательно не проектировалось 3640–3654
...
<!-- docs/architecture.md, раздел 11.1, строки 3035–3051 -->
...
<!-- docs/architecture.md, раздел 11.4, строки 3107–3117 -->
...
<!-- docs/architecture.md, раздел 12.1, строки 3134–3157 -->
