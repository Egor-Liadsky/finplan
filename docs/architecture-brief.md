...
- **4. Схема базы данных** — строки 840–1493
  - 4.1 Общие соглашения 842–862; 4.2 Неизменяемый журнал против пересчитываемых данных 863–887; 4.3 Таблицы 888–1241; 4.4 ER-диаграмма 1242–1403; 4.5 Изоляция данных на уровне БД 1404–1493
- **5. Расчётный слой финансов** — строки 1494–1778
  - 5.1 Соглашения о подсчёте дней 1501–1524; 5.2 Сложный процент 1525–1550; 5.3 Эффективная годовая ставка 1551–1572; 5.4 Начисление с пополнениями и снятиями внутри периода 1573–1632; 5.5 XIRR 1633–1689; 5.6 Цели накопления 1690–1725; 5.7 Прочие расчёты 1726–1762; 5.8 Где что считается 1763–1778
- **6. Сценарии Telegram-бота** — строки 1779–2070
  - 6.1 Команды 1786–1807; 6.2 Разбиение на роутеры aiogram 1808–1843; 6.3 Состояния FSM 1844–1917; 6.4 Хранилище состояний 1918–1936; 6.5 Быстрый ввод одной строкой 1937–1986; 6.6 Валидация ввода 1987–2006; 6.7 Главное меню и клавиатуры 2007–2070
- **7. HTTP-API для SPA** — строки 2071–2451
  - 7.1 Сводка эндпоинтов 2084–2184; 7.2 Пагинация 2185–2212; 7.3 Фильтрация 2213–2232; 7.4 Формат ошибок 2233–2273; 7.5 Примеры ключевых ресурсов 2274–2435; 7.6 Общие заголовки и политики 2436–2451
- **8. Аутентификация и авторизация** — строки 2452–2589
  - 8.1 Модель 2454–2472; 8.2 Проверка подписи Telegram Login Widget 2473–2501; 8.3 Токены 2502–2529; 8.4 Диаграмма входа 2530–2557; 8.5 Авторизация и изоляция данных 2558–2589
- **9. Фоновые задачи и планировщик** — строки 2590–2663
  - 9.1 Выбор планировщика 2592–2621; 9.2 Перечень задач 2622–2642; 9.3 Надёжность выполнения 2643–2663
- **10. Конфигурация и запуск** — строки 2664–2850
  - 10.1 Переменные окружения 2666–2709; 10.2 Файлы настроек 2710–2719; 10.3 docker-compose для локальной разработки 2720–2791; 10.4 Миграции при старте 2792–2818; 10.5 Режим бота: polling против webhook 2819–2835; 10.6 Команды Makefile 2836–2850
- **11. Стратегия тестирования** — строки 2851–2954
  - 11.1 Пирамида 2858–2874; 11.2 Тестирование финансовых расчётов 2875–2901; 11.3 Тестирование хендлеров aiogram 2902–2929; 11.4 Тестирование изоляции пользователей 2930–2940; 11.5 Прочее 2941–2954
- **12. Нефункциональные требования** — строки 2955–3093
  - 12.1 Логирование 2957–2980; 12.2 Обработка ошибок 2981–3010; 12.3 Идемпотентность 3011–3042; 12.4 Резервное копирование 3043–3060; 12.5 Производительность и ограничения 3061–3078; 12.6 Приватность и безопасность 3079–3093
- **13. Этапы внедрения** — строки 3094–3213
- **14. Архитектурные решения и открытые вопросы** — строки 3214–3477
  - 14.1 Принятые решения 3216–3414; 14.2 Открытые вопросы к владельцу продукта 3415–3462; 14.3 Что сознательно не проектировалось 3463–3477
...
<!-- docs/architecture.md, раздел 11.1, строки 2858–2874 -->
...
<!-- docs/architecture.md, раздел 11.4, строки 2930–2940 -->
...
<!-- docs/architecture.md, раздел 12.1, строки 2957–2980 -->
