...
- **3. Доменная модель** — строки 393–723
  - 3.1 Представление денег 395–440; 3.2 Перечисления 441–455; 3.3 Сущности 456–682; 3.4 Связи сущностей 683–723
- **4. Схема базы данных** — строки 724–1308
  - 4.1 Общие соглашения 726–746; 4.2 Неизменяемый журнал против пересчитываемых данных 747–771; 4.3 Таблицы 772–1124; 4.4 ER-диаграмма 1125–1286; 4.5 Изоляция данных на уровне БД 1287–1308
- **5. Расчётный слой финансов** — строки 1309–1593
  - 5.1 Соглашения о подсчёте дней 1316–1339; 5.2 Сложный процент 1340–1365; 5.3 Эффективная годовая ставка 1366–1387; 5.4 Начисление с пополнениями и снятиями внутри периода 1388–1447; 5.5 XIRR 1448–1504; 5.6 Цели накопления 1505–1540; 5.7 Прочие расчёты 1541–1577; 5.8 Где что считается 1578–1593
- **6. Сценарии Telegram-бота** — строки 1594–1883
  - 6.1 Команды 1601–1622; 6.2 Разбиение на роутеры aiogram 1623–1656; 6.3 Состояния FSM 1657–1730; 6.4 Хранилище состояний 1731–1749; 6.5 Быстрый ввод одной строкой 1750–1799; 6.6 Валидация ввода 1800–1819; 6.7 Главное меню и клавиатуры 1820–1883
- **7. HTTP-API для SPA** — строки 1884–2264
  - 7.1 Сводка эндпоинтов 1897–1997; 7.2 Пагинация 1998–2025; 7.3 Фильтрация 2026–2045; 7.4 Формат ошибок 2046–2086; 7.5 Примеры ключевых ресурсов 2087–2248; 7.6 Общие заголовки и политики 2249–2264
- **8. Аутентификация и авторизация** — строки 2265–2402
  - 8.1 Модель 2267–2285; 8.2 Проверка подписи Telegram Login Widget 2286–2314; 8.3 Токены 2315–2342; 8.4 Диаграмма входа 2343–2370; 8.5 Авторизация и изоляция данных 2371–2402
- **9. Фоновые задачи и планировщик** — строки 2403–2476
  - 9.1 Выбор планировщика 2405–2434; 9.2 Перечень задач 2435–2455; 9.3 Надёжность выполнения 2456–2476
- **10. Конфигурация и запуск** — строки 2477–2662
  - 10.1 Переменные окружения 2479–2521; 10.2 Файлы настроек 2522–2531; 10.3 docker-compose для локальной разработки 2532–2603; 10.4 Миграции при старте 2604–2630; 10.5 Режим бота: polling против webhook 2631–2647; 10.6 Команды Makefile 2648–2662
- **11. Стратегия тестирования** — строки 2663–2766
  - 11.1 Пирамида 2670–2686; 11.2 Тестирование финансовых расчётов 2687–2713; 11.3 Тестирование хендлеров aiogram 2714–2741; 11.4 Тестирование изоляции пользователей 2742–2752; 11.5 Прочее 2753–2766
- **12. Нефункциональные требования** — строки 2767–2905
  - 12.1 Логирование 2769–2792; 12.2 Обработка ошибок 2793–2822; 12.3 Идемпотентность 2823–2854; 12.4 Резервное копирование 2855–2872; 12.5 Производительность и ограничения 2873–2890; 12.6 Приватность и безопасность 2891–2905
- **13. Этапы внедрения** — строки 2906–3025
- **14. Архитектурные решения и открытые вопросы** — строки 3026–3289
  - 14.1 Принятые решения 3028–3226; 14.2 Открытые вопросы к владельцу продукта 3227–3274; 14.3 Что сознательно не проектировалось 3275–3289
...
<!-- docs/architecture.md, раздел 3.1, строки 395–440 -->
...
<!-- docs/architecture.md, раздел 4.1, строки 726–746 -->
...
<!-- docs/architecture.md, раздел 11.1, строки 2670–2686 -->
...
<!-- docs/architecture.md, раздел 11.4, строки 2742–2752 -->
...
<!-- docs/architecture.md, раздел 12.1, строки 2769–2792 -->
