...
- **6. Сценарии Telegram-бота** — строки 1805–2115
  - 6.1 Команды 1812–1833; 6.2 Разбиение на роутеры aiogram 1834–1869; 6.3 Состояния FSM 1870–1943; 6.4 Хранилище состояний 1944–1962; 6.5 Быстрый ввод одной строкой 1963–2012; 6.6 Валидация ввода 2013–2051; 6.7 Главное меню и клавиатуры 2052–2115
- **7. HTTP-API для SPA** — строки 2116–2496
  - 7.1 Сводка эндпоинтов 2129–2229; 7.2 Пагинация 2230–2257; 7.3 Фильтрация 2258–2277; 7.4 Формат ошибок 2278–2318; 7.5 Примеры ключевых ресурсов 2319–2480; 7.6 Общие заголовки и политики 2481–2496
- **8. Аутентификация и авторизация** — строки 2497–2634
  - 8.1 Модель 2499–2517; 8.2 Проверка подписи Telegram Login Widget 2518–2546; 8.3 Токены 2547–2574; 8.4 Диаграмма входа 2575–2602; 8.5 Авторизация и изоляция данных 2603–2634
- **9. Фоновые задачи и планировщик** — строки 2635–2708
  - 9.1 Выбор планировщика 2637–2666; 9.2 Перечень задач 2667–2687; 9.3 Надёжность выполнения 2688–2708
- **10. Конфигурация и запуск** — строки 2709–2895
  - 10.1 Переменные окружения 2711–2754; 10.2 Файлы настроек 2755–2764; 10.3 docker-compose для локальной разработки 2765–2836; 10.4 Миграции при старте 2837–2863; 10.5 Режим бота: polling против webhook 2864–2880; 10.6 Команды Makefile 2881–2895
- **11. Стратегия тестирования** — строки 2896–2999
  - 11.1 Пирамида 2903–2919; 11.2 Тестирование финансовых расчётов 2920–2946; 11.3 Тестирование хендлеров aiogram 2947–2974; 11.4 Тестирование изоляции пользователей 2975–2985; 11.5 Прочее 2986–2999
- **12. Нефункциональные требования** — строки 3000–3138
  - 12.1 Логирование 3002–3025; 12.2 Обработка ошибок 3026–3055; 12.3 Идемпотентность 3056–3087; 12.4 Резервное копирование 3088–3105; 12.5 Производительность и ограничения 3106–3123; 12.6 Приватность и безопасность 3124–3138
- **13. Этапы внедрения** — строки 3139–3258
- **14. Архитектурные решения и открытые вопросы** — строки 3259–3522
  - 14.1 Принятые решения 3261–3459; 14.2 Открытые вопросы к владельцу продукта 3460–3507; 14.3 Что сознательно не проектировалось 3508–3522
...
<!-- docs/architecture.md, раздел 11.1, строки 2903–2919 -->
...
<!-- docs/architecture.md, раздел 11.4, строки 2975–2985 -->
...
<!-- docs/architecture.md, раздел 12.1, строки 3002–3025 -->
