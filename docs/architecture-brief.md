...
- **2. Структура репозитория** — строки 182–424
  - 2.1 Дерево каталогов 203–376; 2.2 Правила слоёв 377–424
- **3. Доменная модель** — строки 425–824
  - 3.1 Представление денег 427–475; 3.2 Перечисления 476–498; 3.3 Сущности 499–783; 3.4 Связи сущностей 784–824
- **4. Схема базы данных** — строки 825–1409
  - 4.1 Общие соглашения 827–847; 4.2 Неизменяемый журнал против пересчитываемых данных 848–872; 4.3 Таблицы 873–1225; 4.4 ER-диаграмма 1226–1387; 4.5 Изоляция данных на уровне БД 1388–1409
- **5. Расчётный слой финансов** — строки 1410–1694
  - 5.1 Соглашения о подсчёте дней 1417–1440; 5.2 Сложный процент 1441–1466; 5.3 Эффективная годовая ставка 1467–1488; 5.4 Начисление с пополнениями и снятиями внутри периода 1489–1548; 5.5 XIRR 1549–1605; 5.6 Цели накопления 1606–1641; 5.7 Прочие расчёты 1642–1678; 5.8 Где что считается 1679–1694
- **6. Сценарии Telegram-бота** — строки 1695–1986
  - 6.1 Команды 1702–1723; 6.2 Разбиение на роутеры aiogram 1724–1759; 6.3 Состояния FSM 1760–1833; 6.4 Хранилище состояний 1834–1852; 6.5 Быстрый ввод одной строкой 1853–1902; 6.6 Валидация ввода 1903–1922; 6.7 Главное меню и клавиатуры 1923–1986
- **7. HTTP-API для SPA** — строки 1987–2367
  - 7.1 Сводка эндпоинтов 2000–2100; 7.2 Пагинация 2101–2128; 7.3 Фильтрация 2129–2148; 7.4 Формат ошибок 2149–2189; 7.5 Примеры ключевых ресурсов 2190–2351; 7.6 Общие заголовки и политики 2352–2367
- **8. Аутентификация и авторизация** — строки 2368–2505
  - 8.1 Модель 2370–2388; 8.2 Проверка подписи Telegram Login Widget 2389–2417; 8.3 Токены 2418–2445; 8.4 Диаграмма входа 2446–2473; 8.5 Авторизация и изоляция данных 2474–2505
- **9. Фоновые задачи и планировщик** — строки 2506–2579
  - 9.1 Выбор планировщика 2508–2537; 9.2 Перечень задач 2538–2558; 9.3 Надёжность выполнения 2559–2579
- **10. Конфигурация и запуск** — строки 2580–2765
  - 10.1 Переменные окружения 2582–2624; 10.2 Файлы настроек 2625–2634; 10.3 docker-compose для локальной разработки 2635–2706; 10.4 Миграции при старте 2707–2733; 10.5 Режим бота: polling против webhook 2734–2750; 10.6 Команды Makefile 2751–2765
- **11. Стратегия тестирования** — строки 2766–2869
  - 11.1 Пирамида 2773–2789; 11.2 Тестирование финансовых расчётов 2790–2816; 11.3 Тестирование хендлеров aiogram 2817–2844; 11.4 Тестирование изоляции пользователей 2845–2855; 11.5 Прочее 2856–2869
- **12. Нефункциональные требования** — строки 2870–3008
  - 12.1 Логирование 2872–2895; 12.2 Обработка ошибок 2896–2925; 12.3 Идемпотентность 2926–2957; 12.4 Резервное копирование 2958–2975; 12.5 Производительность и ограничения 2976–2993; 12.6 Приватность и безопасность 2994–3008
- **13. Этапы внедрения** — строки 3009–3128
- **14. Архитектурные решения и открытые вопросы** — строки 3129–3392
  - 14.1 Принятые решения 3131–3329; 14.2 Открытые вопросы к владельцу продукта 3330–3377; 14.3 Что сознательно не проектировалось 3378–3392
...
<!-- docs/architecture.md, раздел 2.2, строки 377–424 -->
...
<!-- docs/architecture.md, раздел 3.1, строки 427–475 -->
...
<!-- docs/architecture.md, раздел 4.1, строки 827–847 -->
...
<!-- docs/architecture.md, раздел 11.1, строки 2773–2789 -->
...
<!-- docs/architecture.md, раздел 11.4, строки 2845–2855 -->
...
<!-- docs/architecture.md, раздел 12.1, строки 2872–2895 -->
