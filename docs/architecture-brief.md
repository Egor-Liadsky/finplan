...
- **3. Доменная модель** — строки 434–839
  - 3.1 Представление денег 436–484; 3.2 Перечисления 485–507; 3.3 Сущности 508–798; 3.4 Связи сущностей 799–839
- **4. Схема базы данных** — строки 840–1500
  - 4.1 Общие соглашения 842–862; 4.2 Неизменяемый журнал против пересчитываемых данных 863–887; 4.3 Таблицы 888–1248; 4.4 ER-диаграмма 1249–1410; 4.5 Изоляция данных на уровне БД 1411–1500
- **5. Расчётный слой финансов** — строки 1501–1785
  - 5.1 Соглашения о подсчёте дней 1508–1531; 5.2 Сложный процент 1532–1557; 5.3 Эффективная годовая ставка 1558–1579; 5.4 Начисление с пополнениями и снятиями внутри периода 1580–1639; 5.5 XIRR 1640–1696; 5.6 Цели накопления 1697–1732; 5.7 Прочие расчёты 1733–1769; 5.8 Где что считается 1770–1785
- **6. Сценарии Telegram-бота** — строки 1786–2077
  - 6.1 Команды 1793–1814; 6.2 Разбиение на роутеры aiogram 1815–1850; 6.3 Состояния FSM 1851–1924; 6.4 Хранилище состояний 1925–1943; 6.5 Быстрый ввод одной строкой 1944–1993; 6.6 Валидация ввода 1994–2013; 6.7 Главное меню и клавиатуры 2014–2077
- **7. HTTP-API для SPA** — строки 2078–2458
  - 7.1 Сводка эндпоинтов 2091–2191; 7.2 Пагинация 2192–2219; 7.3 Фильтрация 2220–2239; 7.4 Формат ошибок 2240–2280; 7.5 Примеры ключевых ресурсов 2281–2442; 7.6 Общие заголовки и политики 2443–2458
- **8. Аутентификация и авторизация** — строки 2459–2596
  - 8.1 Модель 2461–2479; 8.2 Проверка подписи Telegram Login Widget 2480–2508; 8.3 Токены 2509–2536; 8.4 Диаграмма входа 2537–2564; 8.5 Авторизация и изоляция данных 2565–2596
- **9. Фоновые задачи и планировщик** — строки 2597–2670
  - 9.1 Выбор планировщика 2599–2628; 9.2 Перечень задач 2629–2649; 9.3 Надёжность выполнения 2650–2670
- **10. Конфигурация и запуск** — строки 2671–2857
  - 10.1 Переменные окружения 2673–2716; 10.2 Файлы настроек 2717–2726; 10.3 docker-compose для локальной разработки 2727–2798; 10.4 Миграции при старте 2799–2825; 10.5 Режим бота: polling против webhook 2826–2842; 10.6 Команды Makefile 2843–2857
- **11. Стратегия тестирования** — строки 2858–2961
  - 11.1 Пирамида 2865–2881; 11.2 Тестирование финансовых расчётов 2882–2908; 11.3 Тестирование хендлеров aiogram 2909–2936; 11.4 Тестирование изоляции пользователей 2937–2947; 11.5 Прочее 2948–2961
- **12. Нефункциональные требования** — строки 2962–3100
  - 12.1 Логирование 2964–2987; 12.2 Обработка ошибок 2988–3017; 12.3 Идемпотентность 3018–3049; 12.4 Резервное копирование 3050–3067; 12.5 Производительность и ограничения 3068–3085; 12.6 Приватность и безопасность 3086–3100
- **13. Этапы внедрения** — строки 3101–3220
- **14. Архитектурные решения и открытые вопросы** — строки 3221–3484
  - 14.1 Принятые решения 3223–3421; 14.2 Открытые вопросы к владельцу продукта 3422–3469; 14.3 Что сознательно не проектировалось 3470–3484
...
<!-- docs/architecture.md, раздел 4.1, строки 842–862 -->
...
<!-- docs/architecture.md, раздел 11.1, строки 2865–2881 -->
...
<!-- docs/architecture.md, раздел 11.4, строки 2937–2947 -->
...
<!-- docs/architecture.md, раздел 12.1, строки 2964–2987 -->
