...
- **2. Структура репозитория** — строки 182–438
  - 2.1 Дерево каталогов 203–383; 2.2 Правила слоёв 384–438
- **3. Доменная модель** — строки 439–863
  - 3.1 Представление денег 441–489; 3.2 Перечисления 490–512; 3.3 Сущности 513–822; 3.4 Связи сущностей 823–863
- **4. Схема базы данных** — строки 864–1524
  - 4.1 Общие соглашения 866–886; 4.2 Неизменяемый журнал против пересчитываемых данных 887–911; 4.3 Таблицы 912–1272; 4.4 ER-диаграмма 1273–1434; 4.5 Изоляция данных на уровне БД 1435–1524
- **5. Расчётный слой финансов** — строки 1525–1809
  - 5.1 Соглашения о подсчёте дней 1532–1555; 5.2 Сложный процент 1556–1581; 5.3 Эффективная годовая ставка 1582–1603; 5.4 Начисление с пополнениями и снятиями внутри периода 1604–1663; 5.5 XIRR 1664–1720; 5.6 Цели накопления 1721–1756; 5.7 Прочие расчёты 1757–1793; 5.8 Где что считается 1794–1809
- **6. Сценарии Telegram-бота** — строки 1810–2249
  - 6.1 Команды 1817–1838; 6.2 Разбиение на роутеры aiogram 1839–1913; 6.3 Состояния FSM 1914–2053; 6.4 Хранилище состояний 2054–2072; 6.5 Быстрый ввод одной строкой 2073–2122; 6.6 Валидация ввода 2123–2161; 6.7 Главное меню и клавиатуры 2162–2249
- **7. HTTP-API для SPA** — строки 2250–2630
  - 7.1 Сводка эндпоинтов 2263–2363; 7.2 Пагинация 2364–2391; 7.3 Фильтрация 2392–2411; 7.4 Формат ошибок 2412–2452; 7.5 Примеры ключевых ресурсов 2453–2614; 7.6 Общие заголовки и политики 2615–2630
- **8. Аутентификация и авторизация** — строки 2631–2768
  - 8.1 Модель 2633–2651; 8.2 Проверка подписи Telegram Login Widget 2652–2680; 8.3 Токены 2681–2708; 8.4 Диаграмма входа 2709–2736; 8.5 Авторизация и изоляция данных 2737–2768
- **9. Фоновые задачи и планировщик** — строки 2769–2842
  - 9.1 Выбор планировщика 2771–2800; 9.2 Перечень задач 2801–2821; 9.3 Надёжность выполнения 2822–2842
- **10. Конфигурация и запуск** — строки 2843–3029
  - 10.1 Переменные окружения 2845–2888; 10.2 Файлы настроек 2889–2898; 10.3 docker-compose для локальной разработки 2899–2970; 10.4 Миграции при старте 2971–2997; 10.5 Режим бота: polling против webhook 2998–3014; 10.6 Команды Makefile 3015–3029
- **11. Стратегия тестирования** — строки 3030–3133
  - 11.1 Пирамида 3037–3053; 11.2 Тестирование финансовых расчётов 3054–3080; 11.3 Тестирование хендлеров aiogram 3081–3108; 11.4 Тестирование изоляции пользователей 3109–3119; 11.5 Прочее 3120–3133
- **12. Нефункциональные требования** — строки 3134–3272
  - 12.1 Логирование 3136–3159; 12.2 Обработка ошибок 3160–3189; 12.3 Идемпотентность 3190–3221; 12.4 Резервное копирование 3222–3239; 12.5 Производительность и ограничения 3240–3257; 12.6 Приватность и безопасность 3258–3272
- **13. Этапы внедрения** — строки 3273–3392
- **14. Архитектурные решения и открытые вопросы** — строки 3393–3656
  - 14.1 Принятые решения 3395–3593; 14.2 Открытые вопросы к владельцу продукта 3594–3641; 14.3 Что сознательно не проектировалось 3642–3656

## Дерево каталогов, два уровня

Полное дерево — раздел 2.1, строки 203–383.
...
<!-- docs/architecture.md, раздел 2.2, строки 384–438 -->
...
<!-- docs/architecture.md, раздел 3.1, строки 441–489 -->
...
<!-- docs/architecture.md, раздел 4.1, строки 866–886 -->
...
<!-- docs/architecture.md, раздел 11.1, строки 3037–3053 -->
...
<!-- docs/architecture.md, раздел 11.4, строки 3109–3119 -->
...
<!-- docs/architecture.md, раздел 12.1, строки 3136–3159 -->
